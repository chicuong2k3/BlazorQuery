...
SwrSharp provides comprehensive logging and error handling capabilities for production applications. This includes audit logging, diagnostic information, and robust error handling.

## IQueryLogger Interface

SwrSharp uses the `IQueryLogger` interface for all logging operations. This allows you to integrate with any logging framework (Serilog, NLog, Microsoft.Extensions.Logging, etc.).
...
By default, SwrSharp uses `NullQueryLogger` which does nothing. This ensures zero overhead when logging is not needed.
...
SwrSharp catches and logs errors in event handlers to prevent crashes:
...
SwrSharp provides built-in validation for DefaultQueryFn, but **you are responsible for validating and sanitizing data in your query functions**.

#### Built-in Validation

When using DefaultQueryFn, SwrSharp automatically:
...
**⚠️ IMPORTANT**: SwrSharp validates types, but you must validate and sanitize **data content** in your query functions:
...
```csharp
// ✅ GOOD: Whitelist allowed endpoints
...
✅ **IQueryLogger Interface**: Pluggable logging system  
✅ **Built-in Loggers**: Null (default) and Console  
✅ **Easy Integration**: Microsoft.Extensions.Logging, Serilog, etc.  
✅ **Audit Logging**: All operations logged with context  
✅ **Error Handling**: Robust error handling with meaningful messages  
✅ **Structured Logging**: Query keys and context in all logs  
✅ **Security**: Input validation, authorization, audit trail  
✅ **Performance**: Track query operations and timing  

**⚠️ Security Reminder**: SwrSharp validates types and logs operations, but **YOU must validate data content, implement authorization, and sanitize inputs in your query functions!**

**SwrSharp provides production-ready logging, error handling, and security foundations!** 📊🛡️
