...
Rendering paginated data is a very common UI pattern and in BlazorQuery, it "just works" by including the page information in the query key:
...
This experience is not optimal and unfortunately is how many tools today insist on working. But not BlazorQuery! As you may have guessed, BlazorQuery comes with an awesome feature called `placeholderData` that allows us to get around this.
