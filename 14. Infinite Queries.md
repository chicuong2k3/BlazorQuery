...
Rendering lists that can additively "load more" data onto an existing set of data or "infinite scroll" is a very common UI pattern. BlazorQuery supports infinite queries through the `UseInfiniteQuery` class for querying these types of lists.
