...
SwrSharp provides type safety and audit logging, but **security is a shared responsibility**. This guide covers essential security practices when using SwrSharp in production.

## Understanding Security Boundaries

### What SwrSharp Validates

✅ **Type Safety**: Ensures query results match expected types  
✅ **Null Safety**: Validates non-nullable value types  
✅ **Audit Logging**: Tracks all query operations  

### What YOU Must Validate

⚠️ **Data Content**: Validate all data from external sources  
⚠️ **Authorization**: Check user permissions before data access  
⚠️ **Input Sanitization**: Clean all user inputs to prevent injection  
⚠️ **Business Rules**: Enforce your application's security policies  
...
✅ **Validate Everything**: Never trust external data  
✅ **Whitelist Endpoints**: Only allow known endpoints  
✅ **Sanitize Inputs**: Clean all user inputs  
✅ **Check Authorization**: Verify permissions before access  
✅ **Validate Responses**: Ensure data meets business rules  
✅ **Rate Limiting**: Prevent abuse  
✅ **Audit Logging**: Track all security events  
✅ **Error Handling**: Don't leak sensitive information  

**⚠️ CRITICAL**: SwrSharp provides the infrastructure, but **YOU are responsible for implementing security in your query functions!**
